...
class OMXPlayer:
    ...
    def pause(self):
        subprocess.Popen(['/home/pi/pi_video_looper/Adafruit_Video_Looper/dbuscontrol.sh', 'pause'],
                                         stdout=open(os.devnull, 'wb'),
                                         close_fds=True)
        
    def resume(self):
        subprocess.Popen(['/home/pi/pi_video_looper/Adafruit_Video_Looper/dbuscontrol.sh', 'play'],
                                         stdout=open(os.devnull, 'wb'),
                                         close_fds=True)
